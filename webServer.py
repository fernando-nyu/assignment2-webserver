...
def webServer(LHOST="127.0.0.1", port=None):
  serverSocket = socket(AF_INET, SOCK_STREAM)
  # Prepare server socket
  if port is None:
    serverSocket.bind((LHOST, port))
  ...
  while True:
    ...
    try:
      ...
      f = open(filename[1:], 'rb') #fill #Fill in start -a client is sending you a message   #Fill in end in start #fill in end)
      #fill in end
